...
public class Event extends BackendlessData {
    ...
    public void addEventStatus_ID_Event(EventUserStatus e) {
        if (EventUserStatus_ID_Event == null) {
            EventUserStatus_ID_Event = new ArrayList<>();
        }
        this.EventUserStatus_ID_Event.add(e);
    }
